 ...
 */
package Questao06.view;

import Questao06.Vendedor;

/**
 *
 * @author Samuel Melo
 */
public class Tela06 extends javax.swing.JFrame {

    /**
     * Creates new form Tela06
     */
    public Tela06() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Dados Vendas ");

        txttotalvendas.setHorizontalAlignment(javax.swing.JTextField.LEFT);
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addComponent(jLabel3)
                .addGap(10, 10, 10)
                .addComponent(txtnomevendedor, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(10, 10, 10)
                .addComponent(jLabel2)
                .addGap(10, 10, 10)
                ...
                .addComponent(txttotalvendas, javax.swing.GroupLayout.PREFERRED_SIZE, 35, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(30, 30, 30)
    ...
    private void btncalcularActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btncalcularActionPerformed
        ...
        String totalvendas= txttotalvendas.getText();
        Vendedor venda = new Vendedor();
        double total=venda.Salario(Double.parseDouble(salario),  Double.parseDouble(totalvendas));
        System.out.println(total);
        String strtotal =Double.toString(total);
        txtarea.setText("Nome do Vendedor:"+nome+"\n"+"Salario Fixo:"+salario+"\n"+"Salario Total:"+strtotal);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Tela06.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
